...
class HTML_QuickForm2_Rule_CompareTest extends TestCase
{
    ...
    public function testOptionsHandling()
    {
        ...
        $arraySingle = new HTML_QuickForm2_Rule_Compare($mockEl, '...', ['foo']);
        $this->assertTrue($arraySingle->validate());

        $arrayNumeric = new HTML_QuickForm2_Rule_Compare($mockEl, '...', ['!==', 'bar']);
        $this->assertTrue($arrayNumeric->validate());

        $arrayAssoc = new HTML_QuickForm2_Rule_Compare($mockEl, '...',
                            ['operator' => '!==', 'operand' => 'bar']);
    ...
    public function testConfigHandling()
    {
        ...
        HTML_QuickForm2_Factory::registerRule('compare-single', 'HTML_QuickForm2_Rule_Compare', null, ['!==']);
        $arraySingle = HTML_QuickForm2_Factory::createRule('compare-single', $mockEl, '...', 'bar');
        $this->assertTrue($arraySingle->validate());

        HTML_QuickForm2_Factory::registerRule('compare-numeric', 'HTML_QuickForm2_Rule_Compare', null, ['!==', 'bar']);
