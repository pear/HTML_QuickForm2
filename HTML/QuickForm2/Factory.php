...
class HTML_QuickForm2_Factory
{
    ...
    */
    protected static $registeredRules = [
        ...
        'mimetypeserver' => ['HTML_QuickForm2_Rule_MimeTypeServer', null],
